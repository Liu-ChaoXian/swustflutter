...
class _DetailInfoJudgePageState extends State<DetailInfoJudgePage> {
  ...
  Future<dynamic> getPassJudge(Map paras) async{
    print('getPassJudge');
    return await apiClient.judgePass(paras, Constant.userConfigInfo.authtoken);
  }

  Future<dynamic> getFailJudge(Map paras) async {
    return await apiClient.judgeFail(paras, Constant.userConfigInfo.authtoken);
  }

  passJudge(String labId) async{
    return () {
      print(labId);
      paras['labId'] = labId;
      paras['result'] = 'pass';
                    ...
                    children: <Widget>[
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Text('${widget.experimentInfo.experimentName}',
                                style: _normalFont),
                          )])])),
              Card(
                  color: Color.fromARGB(255, 240, 240, 240),
                      ...
                      children: <Widget>[
                        Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Text('${widget.experimentInfo.experimentAddress}',
                                    style: _normalFont),
                              )])])),
              Card(
                  color: Color.fromARGB(255, 240, 240, 240),
